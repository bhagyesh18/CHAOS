...
<div id="header"></div>
      ...
      <div class="container-fluid">
			...
			<div class="panel panel-default">
 			<div class="panel-heading"> <span class="glyphicon glyphicon-th-list"></span> Categories </div>
			...
			<table id="categoryDatatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
				...
				<c:forEach var="items" items="${listCategories}">
					<tr>
						<td>${items.name}</td>
						<td>${items.description}</td>
						<td>
							<div class="btn-group" role="group"	aria-label="Password operations">
												<a href="${pageContext.request.contextPath}/deleteCategory?id=${items.id}">
												  <span class="glyphicon glyphicon-trash"></span>
												</a> &nbsp;
												<a href="${pageContext.request.contextPath}/editCategory?id=${items.id}">
